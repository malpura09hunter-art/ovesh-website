(function(){'use strict';
const fallback=[
{id:"cloud-security",name:"Cloud Security",category:"Cybersecurity",icon:"☁",price:15000,description:"Comprehensive cloud security assessments, configuration reviews, IAM hardening and risk reduction across modern cloud environments.",features:["Cloud Security Assessment","IAM Review","Storage & Database Security","Network Hardening","Misconfiguration Detection","Risk Assessment"],quote:true},
{id:"penetration-testing",name:"Penetration Testing",category:"Cybersecurity",icon:"⌁",price:25000,description:"Authorized penetration testing for web applications, APIs, networks and infrastructure with detailed findings and remediation guidance.",features:["Web App Testing","API Security Testing","Network Testing","Privilege Escalation","Auth Testing","Detailed Report"],quote:true},
{id:"vulnerability-assessment",name:"Vulnerability Assessment",category:"Cybersecurity",icon:"◉",price:10000,description:"Identify, analyze and prioritize vulnerabilities across websites, applications, networks and infrastructure with actionable remediation guidance.",features:["Vulnerability Scanning","Manual Verification","OWASP Top 10","CVE Identification","Risk Prioritization","Security Reports"],quote:true},
{id:"security-consulting",name:"Security Consulting",category:"Cybersecurity",icon:"◇",price:5000,description:"Practical cybersecurity guidance tailored to your organization, infrastructure, technology decisions and risk profile.",features:["Security Strategy","Risk Assessment","Architecture Review","Compliance Guidance","Vendor Advisory","Incident Response Planning"],quote:true},
{id:"security-audits",name:"Security Audits",category:"Cybersecurity",icon:"▣",price:15000,description:"Comprehensive audits of applications, infrastructure, configurations and security controls against recognized best practices and standards.",features:["Configuration Review","Infrastructure Assessment","Compliance Gap Analysis","Control Evaluation","Risk Assessment","Executive Report"],quote:true},
{id:"secure-website-development",name:"Secure Website Development",category:"Websites",icon:"◈",price:20000,description:"Fast, responsive and secure websites built with modern technologies, security best practices, SEO foundations and long-term scalability.",features:["Responsive Design","Secure Coding","Performance Optimization","SEO-Friendly Development","Security Hardening","Maintenance & Support"],quote:true},
{id:"ai-development",name:"AI Development",category:"AI",icon:"✦",price:30000,description:"Custom AI applications, assistants and intelligent systems using modern LLMs, machine learning and secure integrations.",features:["Custom AI Apps","AI Assistants","LLM Integration","AI Automation","Prompt Engineering","Secure AI Deployment"],quote:true},
{id:"seo-optimization",name:"SEO Optimization Services",category:"SEO",icon:"⌕",price:8000,description:"Data-driven SEO services covering technical audits, keyword strategy, on-page optimization, performance and search visibility.",features:["Technical SEO Audit","Keyword Research","On-Page SEO","Schema Markup","Search Console Setup","Performance Tracking"],quote:true},
...
{id:"website-security",name:"Website Security",category:"Cybersecurity",icon:"◈",price:7500,description:"Strengthen website defenses through security hardening, vulnerability mitigation, malware remediation and ongoing monitoring.",features:["Security Hardening","Vulnerability Mitigation","Malware Remediation","Security Headers","Monitoring","Risk Reduction"],quote:true},
{id:"osint-solutions",name:"OSINT Solutions",category:"Cybersecurity",icon:"◎",price:10000,description:"Ethical open-source intelligence solutions for digital footprint analysis, exposure assessment, investigations and security intelligence.",features:["Digital Footprint Analysis","Exposure Detection","Domain Intelligence","Threat Intelligence","SOCMINT","OSINT Reports"],quote:true},
{id:"digital-investigation",name:"Digital Investigation",category:"Cybersecurity",icon:"⌖",price:15000,description:"Evidence-based digital investigations for cyber incidents, online fraud, data breaches and suspicious digital activity.",features:["Incident Investigation","Digital Evidence Collection","Timeline Reconstruction","Fraud Investigation","Log Analysis","Confidential Reports"],quote:true},
{id:"api-security",name:"API Security",category:"Cybersecurity",icon:"⇄",price:15000,description:"Security assessment, testing and hardening for REST, GraphQL and other APIs against modern threats.",features:["REST API Testing","GraphQL Assessment","Authentication & Authorization Review","OWASP API Security Top 10","Rate Limiting","Input Validation"],quote:true},
{id:"custom-software-development",name:"Custom Software Development",category:"Software",icon:"⌘",price:35000,description:"Secure, scalable and high-performance software tailored to business requirements, including web applications, systems, automation tools and dashboards.",features:["Custom Web Applications","Business Systems","Secure API Development","Database Integration","Automation Solutions","Admin Dashboards & CMS"],quote:true},
