(function(){'use strict';
const fallback=[
{id:"cloud-security",name:"Cloud Security",category:"Cybersecurity",icon:"☁",price:0,description:"Comprehensive cloud security assessments, configuration reviews, IAM hardening and risk reduction across modern cloud environments.",features:["Cloud Security Assessment","IAM Review","Storage & Database Security","Network Hardening","Misconfiguration Detection","Risk Assessment"],quote:true},
{id:"penetration-testing",name:"Penetration Testing",category:"Cybersecurity",icon:"⌁",price:0,description:"Authorized penetration testing for web applications, APIs, networks and infrastructure with detailed findings and remediation guidance.",features:["Web App Testing","API Security Testing","Network Testing","Privilege Escalation","Auth Testing","Detailed Report"],quote:true},
{id:"vulnerability-assessment",name:"Vulnerability Assessment",category:"Cybersecurity",icon:"◉",price:0,description:"Identify, analyze and prioritize vulnerabilities across websites, applications, networks and infrastructure with actionable remediation guidance.",features:["Vulnerability Scanning","Manual Verification","OWASP Top 10","CVE Identification","Risk Prioritization","Security Reports"],quote:true},
{id:"security-consulting",name:"Security Consulting",category:"Cybersecurity",icon:"◇",price:0,description:"Practical cybersecurity guidance tailored to your organization, infrastructure, technology decisions and risk profile.",features:["Security Strategy","Risk Assessment","Architecture Review","Compliance Guidance","Vendor Advisory","Incident Response Planning"],quote:true},
{id:"security-audits",name:"Security Audits",category:"Cybersecurity",icon:"▣",price:0,description:"Comprehensive audits of applications, infrastructure, configurations and security controls against recognized best practices and standards.",features:["Configuration Review","Infrastructure Assessment","Compliance Gap Analysis","Control Evaluation","Risk Assessment","Executive Report"],quote:true},
{id:"secure-website-development",name:"Secure Website Development",category:"Websites",icon:"◈",price:0,description:"Fast, responsive and secure websites built with modern technologies, security best practices, SEO foundations and long-term scalability.",features:["Responsive Design","Secure Coding","Performance Optimization","SEO-Friendly Development","Security Hardening","Maintenance & Support"],quote:true},
{id:"ai-development",name:"AI Development",category:"AI",icon:"✦",price:0,description:"Custom AI applications, assistants and intelligent systems using modern LLMs, machine learning and secure integrations.",features:["Custom AI Apps","AI Assistants","LLM Integration","AI Automation","Prompt Engineering","Secure AI Deployment"],quote:true},
{id:"seo-optimization",name:"SEO Optimization Services",category:"SEO",icon:"⌕",price:0,description:"Data-driven SEO services covering technical audits, keyword strategy, on-page optimization, performance and search visibility.",features:["Technical SEO Audit","Keyword Research","On-Page SEO","Schema Markup","Search Console Setup","Performance Tracking"],quote:true},
{id:"ai-automation",name:"AI Automation",category:"AI",icon:"⚙",price:20000,description:"Streamline repetitive business processes with intelligent AI-powered workflows, integrations and automation systems.",features:["Workflow Automation","AI Chatbots","Document & Data Processing","CRM Automation","Email & Task Automation","Custom API Integrations"],quote:true},
{id:"website-security",name:"Website Security",category:"Cybersecurity",icon:"◈",price:0,description:"Strengthen website defenses through security hardening, vulnerability mitigation, malware remediation and ongoing monitoring.",features:["Security Hardening","Vulnerability Mitigation","Malware Remediation","Security Headers","Monitoring","Risk Reduction"],quote:true},
{id:"osint-solutions",name:"OSINT Solutions",category:"Cybersecurity",icon:"◎",price:0,description:"Ethical open-source intelligence solutions for digital footprint analysis, exposure assessment, investigations and security intelligence.",features:["Digital Footprint Analysis","Exposure Detection","Domain Intelligence","Threat Intelligence","SOCMINT","OSINT Reports"],quote:true},
{id:"digital-investigation",name:"Digital Investigation",category:"Cybersecurity",icon:"⌖",price:0,description:"Evidence-based digital investigations for cyber incidents, online fraud, data breaches and suspicious digital activity.",features:["Incident Investigation","Digital Evidence Collection","Timeline Reconstruction","Fraud Investigation","Log Analysis","Confidential Reports"],quote:true},
{id:"api-security",name:"API Security",category:"Cybersecurity",icon:"⇄",price:0,description:"Security assessment, testing and hardening for REST, GraphQL and other APIs against modern threats.",features:["REST API Testing","GraphQL Assessment","Authentication & Authorization Review","OWASP API Security Top 10","Rate Limiting","Input Validation"],quote:true},
{id:"custom-software-development",name:"Custom Software Development",category:"Software",icon:"⌘",price:0,description:"Secure, scalable and high-performance software tailored to business requirements, including web applications, systems, automation tools and dashboards.",features:["Custom Web Applications","Business Systems","Secure API Development","Database Integration","Automation Solutions","Admin Dashboards & CMS"],quote:true},
...
{id:'osint-solutions',name:'OSINT Solutions',category:'Cybersecurity',icon:'◎',price:0,description:'Ethical open-source intelligence solutions for digital footprint analysis, exposure assessment, investigations and security intelligence.',features:['Digital Footprint Analysis','Exposure Detection','Domain Intelligence','Threat Intelligence','SOCMINT','OSINT Reports'],quote:true},
{id:'digital-investigation',name:'Digital Investigation',category:'Cybersecurity',icon:'⌖',price:0,description:'Evidence-based digital investigations for cyber incidents, online fraud, data breaches and suspicious digital activity.',features:['Incident Investigation','Digital Evidence Collection','Timeline Reconstruction','Fraud Investigation','Log Analysis','Confidential Reports'],quote:true},
{id:'api-security',name:'API Security',category:'Cybersecurity',icon:'⇄',price:0,description:'Security assessment, testing and hardening for REST, GraphQL and other APIs against modern threats.',features:['REST API Testing','GraphQL Assessment','Auth Review','OWASP API Top 10','Rate Limiting','Input Validation'],quote:true},
{id:'custom-software-development',name:'Custom Software Development',category:'Software',icon:'⌘',price:0,description:'Secure, scalable and high-performance software tailored to business requirements, including web applications, systems, automation tools and dashboards.',features:['Custom Web Applications','Business Systems','Secure API Development','Database Integration','Automation Solutions','Admin Dashboards & CMS'],quote:true},
{id:'ai-assistant',name:'AI Assistant',category:'AI',icon:'✦',price:10000,description:'A practical AI assistant for FAQs, lead capture and customer support.',features:['Prompt Design','Knowledge Setup','Lead Capture'],quote:true},
{id:'premium-website',name:'Premium Business Website',category:'Websites',icon:'◈',price:30000,description:'A fast, premium business website built around your goals and brand.',features:['Responsive UI','Deployment','Basic Security'],quote:true},
{id:'security-review',name:'Website Security Review',category:'Cybersecurity',icon:'⌁',price:7500,description:'A structured review of common web security risks and hardening opportunities.',features:['Security Review','Findings Report','Hardening Guidance'],quote:true},
...
async function load(){try{if(typeof db!=='undefined'){const s=await db.collection('shop_products').where('status','==','Published').get();if(!s.empty){const remote=s.docs.map(d=>({id:d.id,...d.data()}));const remoteIds=new Set(remote.map(p=>p.id));products=[...remote,...fallback.filter(p=>!remoteIds.has(p.id))];}}}catch(e){console.info('Shop catalog fallback active.')}renderCategories();renderProducts()}
...
window.addToCart=id=>{const p=products.find(x=>x.id===id);if(!p)return;const found=cart.find(x=>x.id===id);if(found)found.qty++;else cart.push({id:p.id,name:p.name,price:Number(p.price||0),qty:1});save();bumpCart();openCart()};
function renderCart(){
